...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function (e) {
    ...
    H.prototype.config = {
        ...
        var e = this, a = e.config,
            l = ['<div class="layui-inline" lay-event="add"><i class="layui-icon layui-icon-add-1"></i></div>', '<div class="layui-inline" lay-event="update"><i class="layui-icon layui-icon-edit"></i></div>', '<div class="layui-inline" lay-event="GET"><i class="layui-icon layui-icon-delete"></i></div>'].join(""),
        ...
        return d.cache[c.key] = u, c.layPage[0 == o || 0 === u.length && 1 == n ? "addClass" : "removeClass"](p), 0 === u.length ? (c.renderForm(), c.errorView(s.text.none)) : (c.layFixed.removeClass(p), r ? b() : (b(), c.renderTotal(u, h), void (s.page && (s.page = t.extend({
            ...
            count: o,
            limit: s.limit,
            limits: s.limits || [10, 20, 50, 100, 500, 1000, 2000, 3000],
            groups: 3,
